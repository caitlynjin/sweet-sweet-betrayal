...
std::shared_ptr<AnimationStateEvent> AnimationStateEvent::allocAnimationStateEvent(int playerID, AnimationStateType animation, bool facing) {
...
void AnimationStateEvent::deserialize(const std::vector<std::byte>& data) {
    ...
    _animation  = static_cast<AnimationStateType>(_deserializer.readSint32());
