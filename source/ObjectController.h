...
public:
   ...
   std::shared_ptr<Object> createWindObstacle(Vec2 pos, Size size, float scale, const Vec2 windDirection, const Vec2 windStrength, const float angle,
       std::string jsonType, bool isLevelEditorMode=false);
