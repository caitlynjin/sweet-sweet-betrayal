...
#define JUMP_BUFFER_DURATION 0.275f
...
protected:
    ...
    bool _holdingJump = false;
    //Soley used to determine the INPUT of holdingjumped.
    bool _justJumped = false;
    bool _justReleased = false;
    //Whether or not we should deliver a jump impulse
    bool _jumpImpulse = false;
    

    //Variable for controlling automatic gliding-set to false after we enter gliding from it
    bool _enterAutoGlide = false;
...
#pragma mark Attribute Properties
    ...
    */
    ...
    //rather than fully ungrounding us.
